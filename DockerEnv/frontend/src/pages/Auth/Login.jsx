...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] grid grid-cols-4 bg-[#F1F3F6]'>
      <div
        className='col-span-1 h-full bg-white flex items-center justify-center'
        style={{ boxShadow: '24.23px 0px 50.49px 0px #0000000D' }}
      >
        <div className='w-full px-6'>
          ...
          <div className='text-center font-semibold text-gray-400 mb-10'>
          ...
          <Form {...form}>
            ...
            >
              ...
              <div className='text-xs underline text-[#1E2772] text-right cursor-pointer'>
                Forgot password?
              </div>

              <Button
                type='submit'
                className='w-full hover:drop-shadow-2xl mt-10'
              >
                Login Now
              </Button>
            </form>
